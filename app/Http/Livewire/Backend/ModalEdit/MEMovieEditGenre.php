...
namespace App\Http\Livewire\Backend\ModalEdit;

use App\Models\Genre;
use App\Models\Movie;
use Livewire\Component;

class MEMovieEditGenre extends Component
{
    public Movie $movie;
    ...
    public function render()
    {
        ...
        return view('livewire.backend.modal-edit.m-e-movie-edit-genre',compact('genres','subGenresAvailable'));
    }
