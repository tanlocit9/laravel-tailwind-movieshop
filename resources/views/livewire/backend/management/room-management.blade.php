<div class="container xl:w-3/5">
    <div id='recipients' class="p-8 m-2 rounded shadow bg-white">
        ...
        <button wire:click="$emit('openRoomAddModal')" class="text-center my-3 bg-blue-700 hover:bg-blue-800 text-black font-bold py-2 px-4 focus:outline-none rounded-2xl">Add Room</button>
        <table id="room" class="display cell-border min-w-full divide-y divide-gray-200 normal-case">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-3 whitespace-nowrap">{{$item->slot}}</td>
