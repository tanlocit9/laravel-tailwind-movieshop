<div class="w-full flex items-center justify-center" x-data="modal()" x-cloak @open-movie-create.window="openModal()"
    @close-movie-create.window="closeModal()">
                    ...
                    <div class="text-base leading-4 space-y-4 text-gray-700 sm:text-lg sm:leading-5">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex flex-col w-1/3">
                                ...
                                <select wire:model="country" name="country" id="country" class="input-text" required>
                            ...
                            <div class="flex flex-col w-1/3">
                                <label class="leading-relaxed" for="genre">Movie genre</label>
                                <select wire:model="genre" name="genre" id="genre" class="input-text" required>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label
                                ...
                                <input wire:model='poster' id="poster" accept="image/*" name="poster" type="file" class="hidden" required>
                            </label>
                        </div>
                    </div>
