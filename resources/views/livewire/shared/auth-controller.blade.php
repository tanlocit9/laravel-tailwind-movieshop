<div class="mx-auto w-full bg-gray-100 flex items-center justify-center h-0" x-data="modal()"
    x-cloak @open-login-form.window="openModal()"
    @close-login-form.window="closeModal()">
                    ...
                    <form method="POST" wire:submit.prevent="register" class="my-5">
                        ...
                        <div class="grid grid-flow-row-dense gap-4">
                            <div>
                                ...
                                <div>
                                    <i class="fa fa-user fa-1x absolute pt-2 pl-3" aria-hidden="true"></i>
                                    <input id="name" type="text" class="input-login" wire:model="name" required
                                        autofocus placeholder="Loc ne">
                                </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <i class="fa fa-lock absolute pt-2 pl-3" aria-hidden="true"></i>
                                    <input id="password" type="password" class="input-login" wire:model="password"
