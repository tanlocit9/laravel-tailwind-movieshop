...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-row md:flex-col">
            <div class="flex-none">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/PqNGHKLyPD0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="ml-10">
                <h2 class="text-4xl mt-4 md:mt-0 font-semibold">Tiệc trăng máu</h2>
                ...
                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, iusto soluta ut reprehenderit explicabo veritatis ex omnis. Ipsum, soluta aut?
                </p>
                {{-- <div class="mt-12">
