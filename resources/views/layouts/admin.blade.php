...
<body class="bg-gray-800">
    <!-- start navbar -->
    <div
        class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-gray-800 p-6 border-b border-gray-300">
        <!-- logo -->
    ...
    <div class="h-screen flex flex-row flex-wrap">
        ...
        <!-- end link --> --}}
                ...
                <!-- end link -->
                <!-- link -->
                <a href="{{ route('manage_genre') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    <i class="fad fa-comments text-xs mr-2"></i>
                    Genres
                </a>
                <!-- link -->
                <a href="{{ route('manage_movie_genre') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    <i class="fad fa-comments text-xs mr-2"></i>
                    Movies - genres
                </a>
                ...
                <!-- link -->
                <a href="{{ route('manage_actor') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    <i class="fad fa-shield-check text-xs mr-2"></i>
                    Actors
                </a>

                <a href="{{ route('manage_movie_actor') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    <i class="fad fa-shield-check text-xs mr-2"></i>
                    Movies - Actors
                </a>
